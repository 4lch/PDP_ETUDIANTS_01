...
## <ins>Préparation</ins>
1. `Forkez` le projet du TP sur votre compte github avec le nom **"PDP_ETUDIANTS_01_TD`<NUMERO_DE_TD>`\_GP`<NUMERO_DE_GROUPE>`"**. Par exemple, le groupe 7 du TD 2 devra créer le repo "PDP_ETUDIANT_01_TD02_GP07"
